...
void SatSolver2::addUnitCNF(Var var, bool val) {
  solver_->addClause(mkLit(var, !val));
}

void SatSolver2::addEqCNF(Var var0, Var var1, bool inv) {
...
void SatSolver2::addAndCNF(Var out, Var in0, bool inv0, Var in1, bool inv1) {
...
void SatSolver2::addXorCNF(Var out, Var in0, bool inv0, Var in1, bool inv1) {
  Lit outLit = mkLit(out, false);
  Lit in0Lit = mkLit(in0, inv0);
  Lit in1Lit = mkLit(in1, inv1);
  // out = in0 ^ in1
